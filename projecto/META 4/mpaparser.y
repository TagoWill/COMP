...
FuncDeclaration:
	...
	| FuncIdent SEMIC FuncBlock 								{$$=inserir_no(is_FUNCDEF2, inserir_irmao($1, $3));}
	| FuncHeading SEMIC FuncBlock 								{$$=inserir_no(is_FUNCDEF, inserir_irmao($1, $3));}
	;
...
Expr3:
	...
	| Expr3 AND Expr4 											{$$=inserir_no(is_AND,inserir_irmao($1, $3));}
